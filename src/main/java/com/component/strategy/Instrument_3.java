...
@Component
@Scope("prototype")
@Qualifier("instrument_3")
public class Instrument_3 implements InstrumentAverageStrategy {

	private static Logger LOG = LoggerFactory.getLogger(Instrument_3.class);
